...
public class StockFlowOutflowState extends StockFlowState {
  //========== Constructor ===========
  public StockFlowOutflowState() {
    super("outflow", StateType.ONGOING);
  }
  ...
  @Override
  public void handle_EVendDecrement(StockFlow object, Context ctx) throws FailedEventHandlingException {
    ...
    //EconomicResource
    EconomicResource economicResource_EconomicResource_StockFlow = (EconomicResource)StubHelper.findBusinessObject(ctx, object.getEconomicResourceId_EconomicResource_StockFlow());
    economicResource_EconomicResource_StockFlow.getCurrentState().handle_EVendDecrement(economicResource_EconomicResource_StockFlow, ctx);
    //EconomicEvent
    EconomicEvent economicEvent_EconomicEvent_StockFlow = (EconomicEvent)StubHelper.findBusinessObject(ctx, object.getEconomicEventId_EconomicEvent_StockFlow());
    economicEvent_EconomicEvent_StockFlow.getCurrentState().handle_EVendDecrement(economicEvent_EconomicEvent_StockFlow, ctx);
  }
