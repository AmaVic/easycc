...
public class ParticipationRecipientState extends ParticipationState {
  //========== Constructor ===========
  public ParticipationRecipientState() {
    super("recipient", StateType.ONGOING);
  }
  ...
  @Override
  public void handle_EVendIncrement(Participation object, Context ctx) throws FailedEventHandlingException {
    ...
    //EconomicEvent
    EconomicEvent economicEvent_EconomicEvent_Participation = (EconomicEvent)StubHelper.findBusinessObject(ctx, object.getEconomicEventId_EconomicEvent_Participation());
    economicEvent_EconomicEvent_Participation.getCurrentState().handle_EVendIncrement(economicEvent_EconomicEvent_Participation, ctx);
    //EconomicAgent
    EconomicAgent economicAgent_EconomicAgent_Participation = (EconomicAgent)StubHelper.findBusinessObject(ctx, object.getEconomicAgentId_EconomicAgent_Participation());
    economicAgent_EconomicAgent_Participation.getCurrentState().handle_EVendIncrement(economicAgent_EconomicAgent_Participation, ctx);
  }
