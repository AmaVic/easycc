...
public class CollaborationSetup {
  ...
  public CollaborationSetup(@JsonProperty("setupFinalized") boolean setupFinalized, @JsonProperty("participantsHandlerPK") String participantsHandlerPK) {
    ...
    this.lastIds.put("EconomicResource", -1);
    this.lastIds.put("EconomicEvent", -1);
    this.lastIds.put("EconomicAgent", -1);
    this.lastIds.put("StockFlow", -1);
    this.lastIds.put("Duality", -1);
    this.lastIds.put("Participation", -1);
    this.lastIds.put("Increment", -1);
    this.lastIds.put("Ownership", -1);
    this.lastIds.put("Decrement", -1);
    this.lastIds.put("DependentView", -1);
  }
